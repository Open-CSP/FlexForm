...
### Changelog
* 2.5.5 : Added form tag : add-as-job. This will put any EDIT functions into jobs. Updated select2.js. Fixed https://github.com/Open-CSP/FlexForm/issues/77
...
* 2.4.0 : Added option to choose which excel tabsheet needs converting
...
* 2.1.33 : Force update DeferredUpdates
