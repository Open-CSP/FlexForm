...
(function (navigator, window, document, $) {
    ...
    Trumbowyg.prototype = {
        ...
        insertFile: function () {
            var t = this;
            t.saveRange();
            t.openModalInsert(t.lang.insertFile, {
                url: {
                    label: 'URL',
                    required: true
                },
                ...
                t.execCmd('insertFile', v.url);
                $('file[src="' + v.url + '"]:not([alt])', t.$box).attr('alt', v.alt);
                return true;
            });
        },
        fullscreen: function () {
        ...
        openModal: function (title, content) {
            ...
            var $form = $('<form/>', {
                ...
                .on('submit reset button', function () {
                    if (t.o.autogrowOnEnter) {
        ...
        buildModalBtn: function (n, $modal) {
            ...
            if ( n == 'button' ) {
              return $('<button/>', {
                  class: prefix + 'modal-button ' + prefix + 'modal-' + 'submit',
                  text: t.lang['submit'] || 'submit'
              }).appendTo($('form', $modal));
            }
            return $('<button/>', {
