        ...
        init: function(o) {
          ...
          var l = {
            fn: function() {
              o.saveRange();
              var a, l = o.o.prefix,
                t = o.openModalInsert(o.lang.upload, {
                  file: {
                    type: "file",
                    required: !0,
                    attributes: {
                  ...
                  var p = new FormData;
                  p.append(o.o.plugins.upload.fileFieldName, a), o.o.plugins.upload.data.map(function(r) {
                    ...
                    success: function(a) {
                      if (o.o.plugins.upload.success) o.o.plugins.upload.success(a, o, t, u);
                      else if (e(a, o.o.plugins.upload.statusPropertyName.split("."))) {
                      ...
                      } else o.addErrorOnModalField(r("input[type=file]", t), o.lang[a.message]), o.$c.trigger("tbwuploaderror", [o, a])
                    },
                    error: o.o.plugins.upload.error || function() {
                      o.addErrorOnModalField(r("input[type=file]", t), o.lang.uploadError), o.$c.trigger("tbwuploaderror", [o])
                    }
                  })
                });
